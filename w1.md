...
high-level segments that demarcate the big data space:

1. Vertical Apps - Predictive policing, BloomReach, Myrrix
2. Ad/Media Apps - Media Science, Turn, Recorded Future
3. Data as a service - Azure, Factual, Grip, Kaggle
4. Business Ingelligence - Oracle, SAP, IBM 
5. Log Data Apps - Splunk, Loggy, Sumo Logic
6. Analytics Infrastructure - EMC, Netezza, Vertica, Hortonworks, Cloudera, DataStax
7. Operational Infrastructure - Teradata, Hadapt
8. IaaS (Infrastructure as a servive) - Amazon web services, Microsoft Azure, Google Cloud Platform
9. Structured Databases - Oralce, SQLServer, MySQL
